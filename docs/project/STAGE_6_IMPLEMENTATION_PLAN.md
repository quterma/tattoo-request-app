...
| 7 | Location polish — **split by owner decision 2026-07-18/19**: (a) **map embed** = `STAGE_6_TASK_07_location_map_embed.md` (`ready`); (b) **studio photos** stay as the shipped placeholder squares, a **pre-deploy swap** (real photos a few days out). Address is real (Herzl 100), provider is fixed (Google Maps iframe). | Item 2 | **map half: task ready** (`STAGE_6_TASK_07_location_map_embed.md`); **photo half: deferred to pre-deploy swap** (asset, not code) | PROJECT_DECISIONS.md — Location page |
