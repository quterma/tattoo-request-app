...
| 5 | Home rebuild (block order; About folded into Hero; Featured Work = **4** placeholder images; 5-step Mini Process; Good Fit + price teasers deep-linking into Process) | Item 2, **Item 6** (teasers link into its sections) | **task ready** (`STAGE_6_TASK_05_home_rebuild.md`) — copy approved 2026-07-23, **no longer content-blocked** | PROJECT_DECISIONS.md — Home page; `research/done/RESEARCH_2026-07-23_stage6-public-copy-positioning.md` |
| 6 | Process page **content rewrite** (FS §3.2 canonical content) + request-form intro (FS §4.1) + `INSTAGRAM_HANDLE`/`__meta_TODO` copy swaps. Ships the approved copy: Overview, Good Fit, Pricing, **Booking & Deposit before Design & Sketch**, Touch-ups, Age (18+, minors → Instagram DM), Languages, Payment, 7-question FAQ (incl. the Preparation/Aftercare links) | Item 2 | **task ready** (`STAGE_6_TASK_06_process_content.md`) — copy approved 2026-07-23, **no longer content-blocked** | PROJECT_DECISIONS.md — Process page; FS §3.2/§4.1/§5; `research/done/RESEARCH_2026-07-23_stage6-public-copy-positioning.md` |
...
| 13 | Final FS §6 acceptance sweep (all 13 criteria) + manual mobile QA — **when cutting this task, name the browser capability its executor will use** (there is no Playwright/Puppeteer/Cypress in `package.json`; the "manual browser check" is unexecutable until the tool is named) and record the evidence in the task itself | Items 1–10, 14 | not started | FS §6; `reviews/done/REVIEW_2026-07-17_impl-brief-channel.md` (round 2, finding 2) |
...
| 15 | **Preparation/Aftercare discovery moves from the global footer to the Process FAQ** — removes the two footer links, amends **PRD §5 + FS §2** together (PRD §9 change control), appends a dated amendment to the 2026-07-14 decision. Reverses part of that decision at owner request 2026-07-23 | **Item 6** (creates the replacement FAQ links — removing the footer first would leave zero discovery) | **task ready** (`STAGE_6_TASK_15_prep_aftercare_discovery.md`) | PROJECT_DECISIONS.md — "Preparation/Aftercare in-product discovery (2026-07-14)" + its 2026-07-23 amendment; PRD §5; FS §2 |
| 16 | **Placeholder visual assets** — favicon drawn as SVG (2–3 options, owner picks; generative models fail at 16×16), plus owner-generated placeholders: studio interiors (2–3), Featured Work (4), OG image (1200×630). All marked `__asset_TODO` and added to the pre-deploy sweep | Items 6, 5 (OG copy + Featured Work slots) | **draft** (`STAGE_6_TASK_16_placeholder_assets.md`) — owner runs the image generation | STRAT brief — Pre-deploy swaps; Item 13 sweep must fail while any `__asset_TODO` remains |
