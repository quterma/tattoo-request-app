...
Primary navigation, identical and persistent on all public pages: **Home, Process, Request, Location** (PRD D9). No secondary navigation hierarchy. Preparation and Aftercare are reachable only by direct URL (PRD §5).
